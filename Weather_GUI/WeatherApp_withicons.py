...
textbox = tk.Entry(frame, font=('Courier', 18))
textbox.place(relwidth=0.65, relheight=1)

submit = tk.Button(frame, text='Get Weather', font=('Courier', 10), command=lambda: get_weather(textbox.get()))
#submit.config(font=)
...
results.config(font=('Courier', 18), bg=bg_color)
